...
author: "DataDemons: Roderick, Andrew, Ross, Mark, Alex"
date: "`r Sys.Date()`"
...
file <- read_csv2("data/per-capita-ocean-plastic-waste.txt")


# Member 6 (pair 3) write code to load File 3 data here:
file_3 <- read_tsv("data/UN_country_population.tsv")



# Member 1 (pair 1) write code to load File 4 data here:
File4 <- read_xlsx("data/UN_country_region.xlsx")
...
file4 <- read_excel("data/UN_country_region.xlsx")

plastic_data_all <- file4 %>%
  select(-name) %>%
  right_join(plastic_data_all, by = "code")
